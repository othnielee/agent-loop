...
- Update the handoff report when complete
...
When complete, **update** the handoff report at `{{OUTPUT_DIR}}/HANDOFF-{{FEATURE_SLUG}}.md`. Do not add duplicate top-level headings. Augment the existing content: append rows to the Files Changed and Acceptance Criteria tables, append bullets under Deviations and Known Issues, and update Verification checkboxes in-place. Use the same structure:
...
- [ ] Handoff report updated with accurate file list
- [ ] Compiler/linter checks pass
- [ ] Relevant tests pass
